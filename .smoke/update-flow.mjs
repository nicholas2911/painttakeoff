...
check('version label shows v0.5.1', (await page.locator('.tb-version').textContent())?.trim() === 'v0.5.1');
...
check('latest-version toast', (await page.locator('.toast').textContent())?.includes('latest version (0.5.1)'));
