...
check('version label shows v0.7.0', (await page.locator('.tb-version').textContent())?.trim() === 'v0.7.0');
...
check('latest-version toast', (await page.locator('.toast').textContent())?.includes('latest version (0.7.0)'));
